...
// LuckAs change FIXME!!!
#define GPIO_PS_EN_PIN	GPIO_ALS_EN_PIN // GPIO183
//#define GPIO_PS_EN_PIN	GPIO_CTP_EN_PIN // GPIO187
// orig
//#define GPIO_PS_EN_PIN	GPIO187
// LuckAs end
...
/*----------------------------------------------------------------------------*/
static int cm3607_ioctl(struct inode *inode, struct file *file, unsigned int cmd,
       unsigned long arg)
{

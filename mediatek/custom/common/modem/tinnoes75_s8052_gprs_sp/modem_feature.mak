...
MODEM_BOARD_VER         = TINNOES15_NAND_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
MODEM_LCD_MODULE        = TINNOES15_NAND_LCM  # Based on the LCM solutions (even multiple LCM modules for this project)
...
MODEM_RFC2507_SUPPORT     = FALSE    # TRUE/FALSE, Enable/Disable RFC2507 IP header compression support
...
MODEM_H264_DECODE_MODE = NONE    # NORMAL,SLIM
...
MODEM_UMTS_MODE_SUPPORT = NONE  # NONE, UMTS_FDD_MODE_SUPPORT, UMTS_TDD128_MODE_SUPPORT
MODEM_IPV6_PDP_SUPPORT = TRUE      # FALSE, not support IPv6 PDP Context
MODEM_HSDPA_SUPPORT = FALSE    # TRUE, FALSE
MODEM_HSUPA_SUPPORT = FALSE    # TRUE, FALSE
MODEM_R99_SUPPORT	    		= TRUE	  # Release 99 support
MODEM_R4_SUPPORT      = TRUE   # Release 4 support
MODEM_R5_SUPPORT      = TRUE   # Release 5 support
MODEM_3SET_F8F9_ENABLE = FALSE  # TRUE, FALSE
...
MODEM_DUALMACDSP_BIN = MT6575_GPRS_REL_ROM
MODEM_DUALMACDSP_BL_BIN = MT6575_REL_BL
...
MODEM_L1_WCDMA          =  FALSE        # L1_WCDMA ............................ this option may not be necessary when project=umts
MODEM_L1L2_TX_NEW_ARCH = TRUE    # TRUE, FALSE
MODEM_L2_HSDPA_COPRO = FALSE    # TRUE: Use L2 HSDPA Coprocessor
MODEM_L2_HSUPA_COPRO = FALSE    # TRUE: Use L2 HSUPA Coprocessor
...
MODEM_SP_VIDEO_CALL_SUPPORT = FALSE    # TRUE, FALSE
...
MODEM_UMTS_RELEASE_SUPPORT	= NONE	    # NONE means for UMTS FDD protocol stack support version of release 99
...
MODEM_FAST_DORMANCY_SUPPORT = FALSE     # TRUE: GEMINI_VERSION = V2
...
MODEM_COM_DEFS_FOR_TINNOES15_NAND_LCM = TINNOES15_NAND_LCM

...
BOARD_VER         = TINNOES15_NAND_BB # Baseband main board description, SHOULD BE ONE OF THE FOLLOWINGS
...
# ------------------------------ HW and Project
# ------------------------------ LCD
LCD_MODULE        = TINNOES15_NAND_LCM  # Based on the LCM solutions (even multiple LCM modules for this project)
...
COM_DEFS_FOR_TINNOES15_NAND_LCM = TINNOES15_NAND_LCM
